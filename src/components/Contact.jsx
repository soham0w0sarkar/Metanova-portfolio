      ...
      <div className="w-full relative">
        ...
        <div
          className={`flex ${
            isMobile
              ? "flex-col space-y-12"
              : "flex-row space-x-8 md:space-x-12 lg:space-x-16"
          }`}
        >
          {/* Contact Form - Left Side on desktop, Top on mobile */}
          <div
            className={`${
              isMobile ? "w-full" : isTablet ? "w-1/2" : "w-5/12"
            } px-2`}
          >
          ...
          {/* Contact Info - Right Side on desktop, Bottom on mobile */}
          <div
            className={`${
              isMobile ? "w-full" : isTablet ? "w-1/2" : "w-5/12"
            } px-2`}
