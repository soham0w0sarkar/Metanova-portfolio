...
const Contact = () => {
  ...
  return (
    <div className="w-full h-full px-24 py-16 text-white pointer-events-auto">
      <h2 className="text-5xl font-bold mb-16 tracking-wider text-center relative">
        <span className="relative">CONTACT US</span>
      </h2>

      <div className="w-full relative">
        {/* Contact Form - Left Side */}
        <div className="absolute left-0 top-0 w-5/12 pl-6">
        ...
        <div className="absolute -right-56 top-0 w-5/12 pr-6">
